...
const website = {
  ...
  title: "Rentwin - Your Reliable Ride, As Long As You Need",
  desc: "Rentwin.com is a trusted platform offering an extensive fleet of quality rental cars for your every need. Our commitment is to provide a seamless car rental experience, where you can pick your preferred vehicle and drive at your convenience. We prioritize customer safety, comfort, and satisfaction. Whether you need a compact car for city driving, a spacious SUV for family adventures, or a luxury model for special occasions, Rentwin has got you covered. Our reliable service, available across multiple cities, ensures you have a dependable ride for as long as you need, wherever your journey takes you.",
  about: {
    title: "About Us",
    desc: [
      "Established in 2014 in the heart of San Francisco, Rentwin emerged from the vision of two experienced travellers, Johnathan Price and Melanie Ross. Having navigated the complexities and frustrations of traditional car rentals during their numerous journeys, they felt compelled to revolutionize the experience for fellow travellers. Johnathan, with his background in technology and a keen interest in the automotive industry, was perfectly suited to tackle the logistical challenges. He dreamt of creating a platform where renting a car would be as easy as ordering a meal online. Melanie, with her rich experience in customer service and operations, shared his vision and was determined to ensure that their service would be customer-centric and hassle-free.",
      "Their shared passion for enhancing the travel experience led to the birth of Rentwin, a platform that combines cutting-edge technology with an unwavering commitment to customer service, providing a seamless car rental experience that is second to none. In our early days, we started with a modest fleet of cars, operating solely in San Francisco. But our dedication to quality and convenience quickly won over our customers. As our reputation grew, so did we. By 2017, we had expanded our operations to cover all of California. Today, we are proud to provide our trusted service in cities all across the United States. Despite our growth, we've never lost sight of our core values - reliability, flexibility, and exceptional service. Every decision we make, every policy we implement, is guided by these principles. We're not just about renting cars; we're about making your journey smoother, safer, and more enjoyable. As we look to the future, we remain committed to innovation and improvement. We continuously update our fleet to include the latest models and ensure our platform stays user-friendly and efficient. We're also excited about expanding our footprint even further, with plans to serve more cities and offer more services to our valued customers",
      "At Rentwin, our mission is to deliver a reliable ride, for as long as you need, wherever your journey takes you. Join us on this exciting ride",
    ],
  },
  contact: {
    title: "Contact Us",
    desc: "At Rentwin, we're always ready to assist you. Our customer service team is available 24/7 to help with your queries, bookings, and feedback. Please don't hesitate to reach out to us via any of the following channels. We look forward to serving you and making your car rental experience the best it can be",
  },
  footer: "© 2023 Rentwin. All rights reserved",
  address:
...
const teamMembers = [
  ...
  },
  {
    ...
    desc: "As the Chief Technology Officer at Rentwin, David Thompson has been crucial in integrating innovative technology into the company's services. He joined the team in 2017 and brought with him extensive experience in developing customer-centric technology solutions. His innovative vision led to the development of the Rentwin online reservation system, making it easier than ever for customers to browse, reserve, and rent vehicles. ",
  },
];
