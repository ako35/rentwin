// Türkiye il listesi + il bazında ilçe listesi (81 il, 973 ilçe).
// Kaynak: api.turkiyeapi.dev (2025 idari bölünüş) — 2026-09-14 itibarıyla
// çekildi. İl adları TR alfabetik sırayla, her ilin ilçeleri de TR
// alfabetik sırayla.
...
export const TR_DISTRICTS = {
  ...
  "Ankara": [
    ...
    "Nallıhan", "Polatlı", "Pursaklar", "Sincan", "Şereflikoçhisar",
    "Yenimahalle",
  ],
  "Antalya": [
  ...
  "Çorum": [
    ...
    "Mecitözü", "Merkez", "Oğuzlar", "Ortaköy", "Osmancık", "Sungurlu",
    "Uğurludağ",
  ],
  "Denizli": [
    "Acıpayam", "Babadağ", "Baklan", "Bekilli", "Beyağaç", "Bozkurt", "Buldan",
    "Çal", "Çameli", "Çardak", "Çivril", "Güney", "Honaz", "Kale",
  ...
  "İzmir": [
    ...
    "Güzelbahçe", "Karabağlar", "Karaburun", "Karşıyaka", "Kemalpaşa", "Kınık",
  ...
  "Kırıkkale": [
    "Bahşılı", "Balışeyh", "Çelebi", "Delice", "Karakeçili", "Keskin",
  ...
  "Konya": [
    ...
    "Ilgın", "Kadınhanı", "Karapınar", "Karatay", "Kulu", "Meram", "Sarayönü",
  ...
  "Ordu": [
    ...
    "Gölköy", "Gülyalı", "Gürgentepe", "İkizce", "Kabadüz", "Kabataş",
  ...
  "Samsun": [
    ...
    "Çarşamba", "Havza", "İlkadım", "Kavak", "Ladik", "Salıpazarı", "Tekkeköy",
  ...
  "Şanlıurfa": [
    ...
    "Haliliye", "Harran", "Hilvan", "Karaköprü", "Siverek", "Suruç",
    "Viranşehir",
  ],
  "Şırnak": [
